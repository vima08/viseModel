 ...
 * @author Vitaly
 */
public class GroupPlusAltrAndEgoExperimentManager extends ExperimentManager {    
    ...
    int groupSize;
    GroupPlusAltruisticStrategy groupStrategy;

    public GroupPlusAltrAndEgoExperimentManager(Experiment experiment, Environment env, Person groupMan, int groupSize, Person egoist, int egoSize, double groupPersentage) throws CloneNotSupportedException {
        ...
        groupStrategy = new GroupPlusAltruisticStrategy(gM, 0.0, groupPersentage);
